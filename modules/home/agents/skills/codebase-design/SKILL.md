...
description: "Use when designing a deep module interface or comparing seam placement."
---
...
- [Interface design](references/interface-design.md): depth, interface tradeoffs, testability, and Mimic examples.
- [Deepening](references/deepening.md): dependency categories and replacing shallow-module tests.
- [Design it twice](references/design-it-twice.md): compare alternative interfaces when requested.
