...
Personal NixOS configuration using **Snowfall Lib** framework for organization. Manages 4 systems (ceres, pallas, vesta, hygiea) with shared modules and per-system customizations.
